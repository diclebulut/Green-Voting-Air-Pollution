...
panel$pm2.5 <- log(panel$pm2.5)
panel$no2 <- log(panel$no2)
panel$pm10 <- log(panel$pm10)
panel$so2 <- log(panel$so2)
panel$bz <- log(panel$bz)
panel$voteShare <- log(panel$voteShare)
