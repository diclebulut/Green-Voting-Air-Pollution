...
colnames(merged_2010) <- c('id', 'Constituency','Year','voteShare','pm2.5', 'no2', 'pm10','so2', 'bz', 'percHighEdu', 'medianIncome')
colnames(merged_2015) <- c('id', 'Constituency','Year','voteShare','pm2.5', 'no2', 'pm10', 'so2', 'bz','percHighEdu', 'medianIncome')
colnames(merged_2017) <- c('id', 'Constituency','Year','voteShare','pm2.5', 'no2', 'pm10', 'so2', 'bz','percHighEdu', 'medianIncome')
colnames(merged_2019) <- c('id', 'Constituency','Year','voteShare','pm2.5', 'no2', 'pm10', 'so2', 'bz','percHighEdu', 'medianIncome')
