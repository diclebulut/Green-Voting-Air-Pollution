...
merged_2010 <- merged_2010[, -c(5,7,8,10,11,13,19,21)]
...
#deleting excess constituency columns
merged_2015 <- merged_2015[, -c(5,7,8,10,11,13,19,21)]
...
#deleting excess constituency columns
merged_2017 <- merged_2017[, -c(5,7,8,10,11,13,19,21)]
...
#deleting excess constituency columns
merged_2019 <- merged_2019[, -c(5,7,8,10,11,13,19,21)]

colnames(merged_2010) <- c('id', 'Constituency','Year','GreenVoteShare', 
                           'ConsVoteShare','LabourVoteShare', 
                           'LibdemVoteShare','pm2.5', 'no2', 'pm10', 'so2', 'bz',
                           'percHighEdu', 'medianIncome')
...
panelAll$medianIncome <- as.numeric(panelAll$medianIncome)
panelAll<- subset(panelAll, !(is.na(panelAll$medianIncome)))
